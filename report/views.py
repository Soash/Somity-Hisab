...
from app1.models import DPS, FDR, ActiveBranch, DPSDeposit, DPSTransactionHistory, FDRTransactionHistory, GeneralAC, GeneralDeposit, GeneralTransactionHistory, Loan_CC, Loan_CC_Collection, Loan_Special, LoanAC, Customer, LoanCollection, LoanFine, SavingsAC, SavingsDeposit, SavingsTransactionHistory, ShareAC, ShareACTransactionHistory
from otrans.models import Deposit, Expense, Income, Passbook
