...
class ExpenseForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'ExpenseBy', 'IsCalculateWithLossProfit', 'ExpenseDate', 'Note'
        ]
        widgets = {
    ...
    def save(self, commit=True):
        ...
        if not instance.VoucherID:
            instance.VoucherID = self.generate_voucher_id()  # Generate VoucherID
        if commit:
            instance.save()
        return instance
...
class IncomeForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'somity', 'voucher_category', 'CustomerName', 'Amount',
            'IncomeBy', 'IsCalculateWithLossProfit', 'IncomeDate', 'Note'
        ]
        widgets = {
